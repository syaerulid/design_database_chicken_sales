...
CREATE TABLE `alamat_user` (
  `IDAlamat` bigint unsigned NOT NULL DEFAULT '0',
  `Alamat` varchar(255) DEFAULT NULL,
  KEY `fk_alamat_up` (`Alamat`),
  CONSTRAINT `fk_alamat_up` FOREIGN KEY (`Alamat`) REFERENCES `user_pesanan` (`Alamat`)
...
INSERT INTO `alamat_user` VALUES (1,'Bombana'),(2,'Kendari'),(3,'Konsel'),(4,'Unaaha');
